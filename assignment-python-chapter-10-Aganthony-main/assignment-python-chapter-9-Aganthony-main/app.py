...
print("Chapter 9.2- Working With Path " + "-" * 20)
...
# two period is the parrent directory .. if desired.
path = Path(".")
...
path = Path("ecommerce/__init__.py")
# Print creation time on Wndows and time changed on Unix
