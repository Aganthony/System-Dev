...
with sqlite3.connect(db_name) as conn:
    # format INSERT INTO with column names. Use ? marks for value placeholder
    sql_command = "INSERT INTO Movies (id,Title,Year) VALUES (?, ?, ?)"
    # Loop through each row in list
    for movie in movies:
        # movies is a list of dictionaries previously read from json file
        # movie is a dictionary
        # movie.value() returns dictionary values for a row in the list
