...
"""
Question to consider about this code:
What is .rglob() and is it different than .glob()? SEe Video 9.3
...
with ZipFile(source_to_unzip) as zip:
    ...
    # target_directory will overwrite existing files without warning
    zip.extractall(target_directory)
    print("done extracting")

    """
	Notes
	source_to_unzip the name of the file to unzip
	...
	The target_directoryis the director where you want the contents
...
for file in list_of_files:
    with ZipFile(file) as zip:
        zip.extractall(target_directory)
print("done extraccting from multiple files")
