    ...
    def set_age(self, age):
        try:
            if 0 <= age <= 130:
                ...
                print("Age must be a number betwee 1 and 130")
        except (ValueError, TypeError):
            print("Age must be a number between 1 and 130")

    def speak(self):
        print(
            f"HI. My name is {self.first_name} {self.last_name}. I am {self.age}")


# create objects of class Person()
# creating an object is call 'instantiation' or instantaite an object of a class Person
p1 = Person("George", "Washington")
p1.set_age(67)
p1.speak()
